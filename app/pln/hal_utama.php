...
<body>
	...
	<footer class="container-fluid bg-4 text-center" style="background-color: #fffefe">
		<p>
		  	<strong>Copyright&nbsp;&copy;&nbsp;2023 <a target="_blank" href="https://www.instagram.com/novamardiani/">Nova Mardiani</a>.</strong>&nbsp;
		  	<br>
		  	<strong>All rights reserved for LSP UBSI.</strong>
		</p>
